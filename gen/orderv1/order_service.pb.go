...
const file_order_service_proto_rawDesc = "" +
	"\n" +
	"\x13order_service.proto\x12\border.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xea\x03\n" +
...
var file_order_service_proto_depIdxs = []int32{
	...
	14, // 1: order.v1.PlaceOrderResponse.order:type_name -> order.v1.ExchangeOrderEntry
	15, // 2: order.v1.PlaceOrderResponse.fill_deltas:type_name -> order.v1.OrderFillEntry
	14, // 3: order.v1.ResolveOrderAttemptResponse.order:type_name -> order.v1.ExchangeOrderEntry
	15, // 4: order.v1.ResolveOrderAttemptResponse.fill_deltas:type_name -> order.v1.OrderFillEntry
	6,  // 5: order.v1.QueryOrderIntentsResponse.intents:type_name -> order.v1.OrderIntentEntry
	21, // 6: order.v1.OrderIntentEntry.time:type_name -> google.protobuf.Timestamp
	13, // 7: order.v1.QueryOrderAttemptsResponse.attempts:type_name -> order.v1.OrderAttemptEntry
	14, // 8: order.v1.QueryOrdersResponse.orders:type_name -> order.v1.ExchangeOrderEntry
	15, // 9: order.v1.QueryOrderFillsResponse.fills:type_name -> order.v1.OrderFillEntry
	21, // 10: order.v1.OrderAttemptEntry.time:type_name -> google.protobuf.Timestamp
	21, // 11: order.v1.ExchangeOrderEntry.time:type_name -> google.protobuf.Timestamp
	21, // 12: order.v1.OrderFillEntry.time:type_name -> google.protobuf.Timestamp
	18, // 13: order.v1.ListOrderLifecycleEventsResponse.events:type_name -> order.v1.OrderLifecycleEventEntry
	19, // 14: order.v1.OrderLifecycleEventEntry.fill_delta:type_name -> order.v1.FillDeltaEntry
	20, // 15: order.v1.OrderLifecycleEventEntry.order_state:type_name -> order.v1.OrderStateEntry
	21, // 16: order.v1.OrderLifecycleEventEntry.occurred_at:type_name -> google.protobuf.Timestamp
	21, // 17: order.v1.OrderLifecycleEventEntry.created_at:type_name -> google.protobuf.Timestamp
	21, // 18: order.v1.FillDeltaEntry.trade_time:type_name -> google.protobuf.Timestamp
	21, // 19: order.v1.OrderStateEntry.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 20: order.v1.OrderService.PlaceOrder:input_type -> order.v1.PlaceOrderRequest
	4,  // 21: order.v1.OrderService.QueryOrderIntents:input_type -> order.v1.QueryOrderIntentsRequest
	7,  // 22: order.v1.OrderService.QueryOrderAttempts:input_type -> order.v1.QueryOrderAttemptsRequest
	9,  // 23: order.v1.OrderService.QueryOrders:input_type -> order.v1.QueryOrdersRequest
	11, // 24: order.v1.OrderService.QueryOrderFills:input_type -> order.v1.QueryOrderFillsRequest
	2,  // 25: order.v1.OrderService.ResolveOrderAttempt:input_type -> order.v1.ResolveOrderAttemptRequest
	16, // 26: order.v1.OrderService.ListOrderLifecycleEvents:input_type -> order.v1.ListOrderLifecycleEventsRequest
	1,  // 27: order.v1.OrderService.PlaceOrder:output_type -> order.v1.PlaceOrderResponse
	5,  // 28: order.v1.OrderService.QueryOrderIntents:output_type -> order.v1.QueryOrderIntentsResponse
	8,  // 29: order.v1.OrderService.QueryOrderAttempts:output_type -> order.v1.QueryOrderAttemptsResponse
	10, // 30: order.v1.OrderService.QueryOrders:output_type -> order.v1.QueryOrdersResponse
	12, // 31: order.v1.OrderService.QueryOrderFills:output_type -> order.v1.QueryOrderFillsResponse
	3,  // 32: order.v1.OrderService.ResolveOrderAttempt:output_type -> order.v1.ResolveOrderAttemptResponse
	17, // 33: order.v1.OrderService.ListOrderLifecycleEvents:output_type -> order.v1.ListOrderLifecycleEventsResponse
